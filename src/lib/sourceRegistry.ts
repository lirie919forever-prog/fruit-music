...
export const MUSIC_SOURCE_REGISTRY: readonly MusicSourceDefinition[] = [
  ...
  {
    name: 'Radio France',
    description: 'Official French public radio streams spanning urban music, culture, classical, and jazz.',
    homepage: 'https://www.radiofrance.fr/',
    capabilities: ['live'],
    integration: 'active',
    note: 'Official live radio, 128 kbps',
    searchable: true,
  },
  {
    ...
    capabilities: ['live'],
    integration: 'active',
    note: 'Live radio, worldwide index and Japan FM',
    searchable: true,
  },
  {
    name: 'Local file',
  ...
  },
  {
    name: 'QQ Music',
    description:
      'Mainstream catalog records with public signed web streams when the source explicitly permits playback.',
    homepage: 'https://y.qq.com/',
    capabilities: ['match'],
    integration: 'active',
    note: 'Public streams are verified before playback; paid items stay unavailable',
    searchable: true,
  },
  {
    name: 'Bilibili',
    description: 'Public music videos and official uploads with audio-only stream resolution.',
    homepage: 'https://www.bilibili.com/',
    capabilities: ['match'],
    integration: 'active',
    note: 'Full-track uploads are duration and byte checked before playback',
    searchable: true,
  },
  {
    name: 'Invidious',
    description: 'YouTube-backed full-track search and streaming with global coverage.',
    homepage: 'https://invidious.io/',
    capabilities: ['match'],
    integration: 'active',
    note: 'Full tracks via YouTube; covers Western, Japanese, Korean, and more',
    searchable: true,
  },
  {
    name: 'Netease',
